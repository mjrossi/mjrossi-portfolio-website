...
// 0` is a revoke wearing the wrong name; a lone positional that is not a link id;
// a reviewer label that cannot be signed), and those messages are the most useful thing in the
